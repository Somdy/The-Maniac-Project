...
public class VariantLouse extends CustomMonster {
    ...
    public void usePreBattleAction() {
        if (AbstractDungeon.ascensionLevel >= 17) {
            this.addToBot(new ApplyPowerAction(this, this, new CurlUpPower(this, AbstractDungeon.monsterHpRng.random(14, 16), AbstractDungeon.monsterHpRng.random(10, 12))));
        }
        else if (AbstractDungeon.ascensionLevel >= 7) {
            this.addToBot(new ApplyPowerAction(this, this, new CurlUpPower(this, AbstractDungeon.monsterHpRng.random(10, 12), AbstractDungeon.monsterHpRng.random(8, 10))));
        } else {
            this.addToBot(new ApplyPowerAction(this, this, new CurlUpPower(this, AbstractDungeon.monsterHpRng.random(6, 8), AbstractDungeon.monsterHpRng.random(6, 8))));
        }
    }
