...
public class UncertaintySpectre extends AbstractPossessedMonster {
    public static final String ID = TheManiac.makeID("UncertaintySpectre");
    private static final MonsterStrings monsterStrings = CardCrawlGame.languagePack.getMonsterStrings(ID);
    public static final String NAME = monsterStrings.NAME;
    private static final String[] DIALOG = monsterStrings.DIALOG;
    private static final String[] MOVES = monsterStrings.MOVES;
    private static final String SPEC_ATLAS = "maniacMod/images/monsters/possessed_enemies/Spectres/violet/skeleton.atlas";
    private static final String SPEC_JSON = "maniacMod/images/monsters/possessed_enemies/Spectres/violet/skeleton.json";
    private static final int sear_count = 3;
    private static final int overflow_count = 4;
    private int searDmg;
    private int turnDmg;
    private int blindDmg;
    private int inflame_str;
    private int inflame_metal;
    private int bleeding_amt;
    ...
    public UncertaintySpectre(int minHp, int maxHp, int baseDmg, int vanishTurn, float x, float y) {
        ...
        this.inflame_str = ascLevel() > 18 ? 3 : 2;
        this.inflame_metal = ascLevel() > 18 ? 4 : 2;
        this.bleeding_amt = ascLevel() > 18 ? 6 : 4;
        ...
        switch (this.nextMove) {
            case 1:
                ...
                for (int i = 0; i < sear_count; i++) {
                    this.addToBot(new SpectreSearAction(new VoidCard(), this.damage.get(1), this, player, ManiacImageMaster.ColorDeviator(Color.VIOLET, 0.2F, 0.4F)));
                }
                break;
            case 2:
                if (firstInflame) {
                    firstInflame = false;
                    int amounts = numRisksInDeck(ManiacRisksCard.Enum.THE_UNCERTAINTIES);
                    if (amounts <= 0)
                        amounts += 2;
                    this.addToBot(new VFXAction(new InflameEffect(this)));
                    this.addToBotPower(this, this, new StrengthPower(this, amounts), amounts);
                    this.addToBotPower(this, this, new MetallicizePower(this, 6), 6);
                } else {
            ...
            case 3:
                ...
                for (int i = 0; i < overflow_count; i++) {
                    ...
                    this.addToBot(new UncertaintyBlindAction());
                }
                break;
            case 4:
                ...
                for (int i = 0; i < turnCount; i++) {
                    ...
                    this.addToBotPower(player, this, new BleedingPower(player, bleeding_amt), bleeding_amt);
                }
                break;
            case 5:
                this.addToBot(new VanishAction(this, false, Color.VIOLET));
                break;
        }
        ...
        if (!this.isDying &&!this.isVanishing && !this.firstInflame) {
            ...
            if (fire_timer < 0F) {
                ...
                AbstractDungeon.effectList.add(new SpectreInflameFireEffect(
                        ...
                        ManiacImageMaster.ColorDeviator(Color.PURPLE, 0.2F, 0.4F)));
            }
        }
    }
}
