...
public class GhostFireBurstParticleEffect extends AbstractGameEffect {
    ...
    public GhostFireBurstParticleEffect(float x, float y) {
        ...
        this.color = new Color(MathUtils.random(0.8F, 0.9F), MathUtils.random(0.07F, 0.08F), MathUtils.random(0.22F, 0.24F), 0.0F);
        this.color.a = 0.0F;
