...
public class SneckouetteSummonParticles extends AbstractGameEffect {
    private float x;
    private float y;
    private float vY;
    private float aV;
    ...
    public SneckouetteSummonParticles(float x, float y) {
        this.color = new Color(0.0F, 0.0F, 0.0F, 1.0F);
        this.color.r = MathUtils.random(0.17F, 0.23F);
        this.color.g = MathUtils.random(0.06F, 0.11F);
        this.color.b = MathUtils.random(0.38F, 0.53F);
