...
public class RecollectUpgradedPower extends AbstractManiacPower implements CloneablePowerInterface {
    public static final String POWER_ID = "maniac:RecollectUpgradedPower";
    ...
    public RecollectUpgradedPower(AbstractCreature owner, int amount, boolean modifyCosts) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
        this.amount = amount;
    ...
    public AbstractPower makeCopy() {
        return new RecollectUpgradedPower(owner, amount, modifyCosts);
    }
}
