...
public class DeadEndPower extends AbstractManiacPower implements CloneablePowerInterface {
    ...
    public void atStartOfTurnPostDraw() {
        if (this.amount > 0) {
            this.addToBot(new MakeTempCardInHandAction(new DeusExMe(), this.amount ,true));
        }
    }
